...
function sliderChart(root, data, DPI_WIDTH) {
  ...
  function mousedown(event) {
    ...
    yData.map((0, _utils.toCoords)(xRatio, yRatio, DPI_HEIGHT, -5)).forEach(function (coords, idx) {
...
function chart(root, data) {
  ...
  function paint() {
    ...
    yData.map((0, _utils.toCoords)(xRatio, yRatio, DPI_HEIGHT, PADDING)).forEach(function (coords, idx) {
      var color = data.colors[yData[idx][0]];
      (0, _utils.line)(ctx, coords, {
        color: color
      });
  ...
  function yAxis(yMin, yMax) {
    ...
    ctx.lineWidth = 1;
    ctx.strokeStyle = '#bbb';
    ctx.font = 'normal 20px Helvetica, sens-serif';
...
},{"./tooltip":"tooltip.js","./data":"data.js","./utils":"utils.js","./slider":"slider.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
